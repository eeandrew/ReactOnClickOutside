...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TestComponent = __webpack_require__(160);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _clickOutside = __webpack_require__(161);
	...
	exports.default = (0, _clickOutside2.default)(TestComponent);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function clickOutside(Component) {
	  var OnClickOutside = function (_React$Component) {
	    _inherits(OnClickOutside, _React$Component);

	    _createClass(OnClickOutside, null, [{
	      key: 'getClass',
	    ...
	    function OnClickOutside(props) {
	      ...
	      var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(OnClickOutside).call(this, props));
	    ...
	    _createClass(OnClickOutside, [{
	      key: '_bindFunc',
	      value: function _bindFunc() {
	        var _this2 = this;

	        var funcs = ['getInstance'];
	        funcs.map(function (func) {
	          _this2[func].bind(_this2);
	        });
	      }
	    }, {
	      key: 'getInstance',
	      ...
	      value: function _outsideClickHandler(evt) {}
	    }, {
	      ...
	      value: function componentDidMount() {
	        ...
	        var fn = this._outsideClickHandler = (0, _util.generateOutsideCheck)(_reactDom2.default.findDOMNode(instance), instance.handleClickOutside, this.props.outsideClickIgnoreClass || _util.IGNORE_CLASS, this.props.preventDefault || false, this.props.stopPropagation || false);

	        var pos = _util.registeredComponents.length;
	        _util.registeredComponents.push(this);
	        _util.handlers[pos] = fn;
	      ...
	      value: function componentWillUnmount() {
	        ...
	        var pos = _util.registeredComponents.indexOf(this);
	        if (pos > -1) {
	          if (_util.handlers[pos]) {
	            _util.handlers.splice(pos, 1);
	          }
	          _util.registeredComponents.splice(pos, 1);
	        }
	      }
	    }, {
	      key: 'render',
...
/***/ function(module, exports) {
	...
	var IGNORE_CLASS = exports.IGNORE_CLASS = 'ignore-onclickoutside';

	var isNodeFound = exports.isNodeFound = function isNodeFound(current, componentNode, ignoreClass) {
	...
	var generateOutsideCheck = exports.generateOutsideCheck = function generateOutsideCheck(componentNode, eventHandler, ignoreClass, preventDefault, stopPropagation) {
	  return function (evt) {
	    if (preventDefault) {
	      evt.preventDefault();
	    }
	...
	var registeredComponents = exports.registeredComponents = [];
